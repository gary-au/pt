...
#' @param window_height numeric, window_height
...
draw_multiple_gambles <- function(gambles, window_width, window_height, 
...
draw_multiple_gambles_internal <- function(gambles, window_width, window_height, decision_square_x, decision_square_y, decision_square_edge_length, circle_radius, y_split_gap, x_split_offset, probability_text_digits, y_probability_text_offset, y_value_text_offset, x_value_text_offset, probability_text_font_colour, probability_text_font_size, objective_consequence_text_font_colour, objective_consequence_text_font_size, label, label_font_colour, label_font_size, label_positions, line_positions, line_colours, line_styles, line_arrows, line_widths)
{
...
draw_single_gamble <- function(gamble, 
	window_width, window_height, 
	centre_x, centre_y, circle_radius, 
...
#'		
#' @export
drawSimplex <- function(window_width, window_height, 
	x1, x2, x3,
	line_dot_density,
