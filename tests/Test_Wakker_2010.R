...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
general_power_utility <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=1))
compareEU(my_choices, utility=general_power_utility, digits=4)

#   cid gid   ev    eu  euce   eurp
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
my_utility <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=1))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
linear_utility <- create_utility(utility_function="linear", parameters=c(lambda=1))
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=0.5, beta=1.0))
compareRDU(my_choices, power_function_probability_weighting, linear_utility, digits=4)
...
my_choices
linear_utility <- create_utility(utility_function="linear", parameters=c(lambda=1))
power_function_probability_weighting <- create_probability_weighting("power", c(alpha=2.0, beta=1.0))
compareRDU(my_choices, power_function_probability_weighting, linear_utility, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
general_power_utility <- create_utility(utility_function="general_power", parameters=c(alpha=0.5, beta=10, lambda=1))
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2.0, beta=1.0))
compareRDU(my_choices, power_function_probability_weighting, general_power_utility, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
general_linear_utility <- create_utility(utility_function="general_linear", parameters=c(alpha=1/100, lambda=1))
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2.0, beta=1.0))
compareRDU(my_choices, power_function_probability_weighting, general_linear_utility, digits=4)
...
my_choices
general_linear_utility <- create_utility(utility_function="general_linear", parameters=c(alpha=1/100, lambda=1))
tk_1992_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.5))
compareRDU(my_choices, tk_1992_positive_probability_weighting, general_linear_utility, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
example_7_2_1_cara_utility <- create_utility(utility_function="exponential", parameters=c(alpha=0.005, lambda=1))
tk_1992_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
compareRDU(my_choices, tk_1992_positive_probability_weighting, example_7_2_1_cara_utility, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
example_9_3_3_cara_utility_with_loss_aversion <- create_utility(utility_function="exponential", parameters=c(alpha=0.005, lambda=2.25))
example_9_3_3_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
example_9_3_3_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
comparePT(my_choices, tk_1992_positive_probability_weighting, example_9_3_3_negative_probability_weighting, example_9_3_3_cara_utility_with_loss_aversion, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
example_9_3_3_linear_basic_utility_with_loss_aversion <- create_utility(utility_function="linear", parameters=c(lambda=2.25))
example_9_3_3_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
example_9_3_3_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
comparePT(my_choices, tk_1992_positive_probability_weighting, example_9_3_3_negative_probability_weighting, example_9_3_3_linear_basic_utility_with_loss_aversion, digits=4)
...
my_choices
example_9_3_3_cara_utility_with_loss_aversion <- create_utility(utility_function="exponential", parameters=c(alpha=0.005, lambda=2.25))
example_9_3_3_linear_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1))
example_9_3_3_linear_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
example_9_3_3_cara_utility_with_no_loss_aversion <- create_utility(utility_function="exponential", parameters=c(alpha=0.005, lambda=1))
example_9_3_3_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
example_9_3_3_linear_basic_utility_with_no_loss_aversion <- create_utility(utility_function="linear", parameters=c(lambda=1))
example_9_3_3_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2, beta=1))
linear_probability_weighting <- create_probability_weighting(probability_function="linear", parameters=c(lambda=1))
exercise_9_3_4_utility <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=2))
comparePT(my_choices, power_function_probability_weighting, linear_probability_weighting, exercise_9_3_4_utility, digits=4)
...
my_choices
tk_1992_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
tk_1992_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.69))
tk_1992_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=0.88, beta=0.88, lambda=2.25))
comparePT(my_choices, tk_1992_positive_probability_weighting, tk_1992_negative_probability_weighting, tk_1992_utility_with_loss_aversion, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
linear_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1))
tk_1992_utility_with_no_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=0.88, beta=0.88, lambda=1))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
tk_1992_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.61))
linear_utility_with_no_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=1))
...
my_choices
linear_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1))
linear_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=2.25))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
tk_1992_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.69))
tk_1992_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.69))
power_utility <- create_utility(utility_function="power", parameters=c(alpha=0.88, beta=0.88, lambda=2))
comparePT(my_choices, tk_1992_positive_probability_weighting, tk_1992_negative_probability_weighting, power_utility, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
power_utility <- create_utility(utility_function="power", parameters=c(alpha=0.88, beta=0.88, lambda=1))
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
tk_1992_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1.0))
tk_1992_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1.0))
power_utility <- create_utility(utility_function="power", parameters=c(alpha=0.88, beta=0.88, lambda=1))
comparePT(my_choices, tk_1992_positive_probability_weighting, tk_1992_negative_probability_weighting, power_utility, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
tk_1992_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.69))
linear_utility_with_no_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=1))
compareRDU(my_choices, tk_1992_probability_weighting, linear_utility_with_no_loss_aversion, digits=4)
...
tk_1992_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=0.69))
linear_utility_with_no_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=1))
comparePT(my_choices, tk_1992_positive_probability_weighting, tk_1992_negative_probability_weighting, linear_utility_with_no_loss_aversion, digits=4)
...
tk_1992_positive_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1.0))
tk_1992_negative_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1.0))
linear_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=2))
comparePT(my_choices, tk_1992_positive_probability_weighting, tk_1992_negative_probability_weighting, linear_utility_with_loss_aversion, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
power_utility <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=1))
compareEU(my_choices, power_utility, digits=4)
...
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2, beta=1))
linear_utility_with_no_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=1))
compareRDU(my_choices, power_function_probability_weighting, linear_utility_with_no_loss_aversion, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
tk_1992_utility_with_no_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=1))
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2, beta=1))
compareRDU(my_choices, power_function_probability_weighting, tk_1992_utility_with_no_loss_aversion, digits=4)
...
my_choices <- create_choices_from_file(input_file=my_input_file, choice_id_header="choice_id", gamble_id_header="gamble_id", outcome_id_header="outcome_id", objective_consequence_header="objective_consequence", probability_header="probability", DELIMITER="\t")
my_choices
linear_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1.0))
linear_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=2.25))
comparePT(my_choices, linear_probability_weighting, linear_probability_weighting, linear_utility_with_loss_aversion, digits=4)
...
my_choices
linear_probability_weighting <- create_probability_weighting(probability_function="Tversky_Kahneman_1992", parameters=c(c=1.0))
tk_1992_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=2.25))
...
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2, beta=1))
linear_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=1, beta=1, lambda=2.25))
comparePT(my_choices, power_function_probability_weighting, power_function_probability_weighting, linear_utility_with_loss_aversion, digits=4)
...
power_function_probability_weighting <- create_probability_weighting(probability_function="power", parameters=c(alpha=2, beta=1))
tk_1992_utility_with_loss_aversion <- create_utility(utility_function="power", parameters=c(alpha=0.5, beta=0.5, lambda=2.25))
comparePT(my_choices, power_function_probability_weighting, power_function_probability_weighting, tk_1992_utility_with_loss_aversion, digits=4)
