...
drawSimplex(window_width=7, window_height=7, 
	x1=0, x2=2400, x3=2500,
	line_dot_density=5000,
...
plotRP(my_title = "risk premium",
	...
	font_scaling=1, window_width = 7, window_height = 7)
invisible(dev.off())
@
...
plotProbWFam(my_title=expression(paste("linear in log odds,  ", 
	...
	font_scaling=1.0, arrow_positions = list(c(0.5,0.25,0.45,0.3),
		c(0.78,0.36,0.8,0.47)), window_width=7, window_height=7)
invisible(dev.off())
@
...
drawChoices(my_choices, window_width=7, window_height=7, 
	decision_square_x=0.2, decision_square_edge_length=0.03,
...
drawChoices(my_list[[2]], window_width=5, window_height=5, 
	decision_square_x=0.2, decision_square_edge_length=0.05,
	circle_radius=0.025, y_split_gap=0.1, x_split_offset=0.03, 
	probability_text_digits=4, y_probability_text_offset=0.015, 
	y_value_text_offset=0.005, x_value_text_offset=0.025, 
